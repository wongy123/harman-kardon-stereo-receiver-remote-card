        ...
        <div class="card">
          ...
          <section>
            ...
            <select .value=${a} @change=${this._selectSource} aria-label="Receiver source">
              ${r.map(t=>I`<option value=${t}>${t}</option>`)}
            </select>
            ${t.assign_analog||t.assign_digital?I`
              <div class="grid two">
